/**
 * Package-owned invariant companion for `@deepseek-ai/dsh-client-ui-replay`.
 * @module @deepseek-ai/dsh-client-ui-replay/invariant
 */
...
const PACKAGE_NAME = '@deepseek-ai/dsh-client-ui-replay'

/** Cordis companion plugin name. */
export const name = 'client-ui-replay-invariant'
